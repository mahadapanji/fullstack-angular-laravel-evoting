                    ...
                    <div class="card-body p-3">
                        <form action="{{ route('login') }}" method="post" id="formLogin">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control text-center fs-5" id="username" name="username" placeholder="username" value="{{ old('username') }}" autofocus required autocomplete="off">
                                <label for="username" id="label_username">NIM / Username</label>
                                @error('username')
                                <div class="small text-danger py-1">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-floating mb-3">
                                <input type="password" class="form-control text-center fs-5" id="password" name="password" placeholder="password" value="{{ old('password') }}" required autocomplete="off">
